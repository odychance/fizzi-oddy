...
const Carousel = ({ slice }: CarouselProps): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      <WavyCircles className="absolute left-1/2 top-1/2 h-[120vmin] -translate-y-1/2 -translate-x-1/2 text-[#710523]"/>
      ...
      <div className="grid grid-cols-[auto,auto,auto] items-center">
        ...
        <View className="aspect-square h-[70vmin] min-h-40">
          <Center position={[0,0,1.5]}>
            <FloatingCan
            ref={sodaCanRef} floatIntensity={.3} rotationIntensity={1} flavor={FLAVORS[currentFlavorIndex].flavor}/>
          </Center>
          <Environment files="/hdr/lobby.hdr"
            environmentIntensity={.6}
            environmentRotation={[0,3,3]}
          />
